(function() {
	...
	$.ajax({
		...
		success: function(data){
			...
			var openweathermapId = data.weather[0].id,
				weathers = {
				...
				imgsSunny = [ 'L0040558.jpg', 'L0041342.jpg', 'L0052309.jpg', 'L0053261.jpg', 'L0053268.jpg', 'L0072364.jpg', 'L0072384.jpg', 'L0074515.jpg', 'V0049411.jpg', 'V0040906.jpg' ],
			...
			var length = weathers[giraffe].length;
				for ( var i = 0; i < length; i++ ) {
					if (weathers[giraffe][i] == openweathermapId) {
						...
						if ( giraffe=="clear" && (data.weather[0].icon.indexOf("d") != -1) ) {
